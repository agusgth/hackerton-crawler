...
class LoginApp:
    def __init__(self, root):
        ...
        self.keywords_entry = ttk.Entry( self.keywords_frame, show="•", font=('Helvetica', 11))
        ...
        ###################################################################################################
        """
        self.meter = ttk.Meter(master=self.root,
            metersize=90,
        padding=5,
        amountused=25,  
        metertype="semi",
    ...
    def verify_login(self):
        ...
        asyncio.run(cm5.main(path,switch1,switch2))
        messagebox.showinfo("Success", "Files exported to "+path, icon='info')
        self.clear_fields()
        """
        if brandname == "admin" and keywords == "123456":
            messagebox.showinfo("Success", "Login successful!", icon='info')
            self.clear_fields()
        else:
            messagebox.showerror("Error", "Invalid brandname or keywords")
